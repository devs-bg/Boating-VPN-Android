...
import com.boating.vpn.CheckInternetConnection;
import com.boating.vpn.R;
import com.boating.vpn.SharedPreference;
import com.boating.vpn.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    String mIp = null;
    volatile static private long startTime = 0L;
    ...
    private void showAlert() {
        ...
        builder.setMessage("Do you want to re-enter them?");

        builder.setTitle("Your credentials are wrong!");
